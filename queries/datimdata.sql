...
from(
	...
	from(
		select facilityname,personid from patienttxcurr where voided = 0 and reportingperiod = 'august2021'
	)report left join(
...
group by alldata.facilityname order by fd.facilityname
-- )results order by rowNumber